package com.ejercicios.SpringSesion7_8_9Ejercicios1_2_3.entities;
...
@Entity
@Table(name = "laptops")
@ApiModel("Entidad laptop para representar un elemento informático portátil con todos sus componentes principales")
public class Laptop {
