package com.ejercicios.SpringSesion4_5_6Ejercicios1_2_3;
...
public class SpringSesion456Ejercicios123Application {

	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(SpringSesion456Ejercicios123Application.class, args);
		LaptopRepository repository = context.getBean(LaptopRepository.class);

		// Ejercicio 2. Los objetos Laptop se pueden insertar desde el método main de la clase principal:
